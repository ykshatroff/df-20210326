...
export const loadSettings = () => {
    const cfg = {
        ...
        API_BASE: '/api/',
        AUTH_TOKEN_NAME: 'df_20210326_token',
        // KEEP `AUTH_TOKEN_LIFETIME` IN SYNC WITH backend ACCESS_TOKEN_LIFETIME
        AUTH_TOKEN_LIFETIME: 30, // This value is in minutes
        AUTH_REFRESH_TOKEN_NAME: 'df_20210326_refresh_token',
        LANGUAGE_COOKIE_NAME: 'df_20210326_language',
    ...
    if (process.env.BUILD_TARGET === 'server') {
        ...
        cfg.LOGGING_DIR =
            process.env.RAZZLE_LOGGING_DIR || '/var/log/df_20210326/';
