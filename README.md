...
Browser support is defined in the `df_20210326/browserslist` file that is used for autoprefixing CSS.
...
|run psql                              |`make psql`                            |`docker-compose exec postgres psql --user df_20210326 --dbname df_20210326` |


## Running commands on the server

    docker-compose -f docker-compose.production.yml run --rm --name df_20210326_tmp django python manage.py <command>
...
- python: [`df_20210326/cover`](./df_20210326/cover)
